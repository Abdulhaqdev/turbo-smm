        ...
        <div className="max-w-2xl mx-auto text-center">
          <div className="mb-6 flex justify-center">
            <svg
              ...
              height="49"
              viewBox="0 0 38 49"
              fill={mounted ? (resolvedTheme === "dark" ? "#FFFFFF" : "#000000") : "#FFFFFF"} // Dynamic fill for light/dark modes, white as SSR fallback
              xmlns="http://www.w3.org/2000/svg"
              className="text-foreground dark:text-white" // Optional: For Tailwind-based coloring if using currentColor
            >
          ...
          <h2 className="mb-4 text-2xl md:text-3xl lg:text-4xl font-bold text-foreground">
            {` Mijozlarni qo'llab-quvvatlash – sizning ishonchli yordamchingiz!`}
          </h2>
          <p className="mb-8 text-muted-foreground text-base md:text-lg">
            {` Bizning jamoamiz har qanday savolingizga javob berish uchun 24/7 rejimda ishlaydi. Qo'shimcha ma'lumot
            kerakmi? Muammo yoki savol tug'ildimi? Biz sizga yordam berishga tayyormiz!`}
          </p>
