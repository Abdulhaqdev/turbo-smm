              ...
              >
                ...
                <div className="p-4 min-w-[200px] space-y-1">
                  ...
                  <div className="text-xs text-zinc-500">
                    {t("table.minOrder")}: {service.min} {t("table.maxOrder")}: {service.max}
                  </div>
                </div>
                ...
                <div className="p-4">
                  <Button
                    ...
                    asChild
                  >
                    <a href={`/${locale}/dashboard/new-order?serviceId=${service.id}`}>
                      {t("table.action")}
                    </a>
                  </Button>
                </div>
              ...
              <div className="p-4 space-y-3">
                <div className="space-y-1">
                  ...
                  <div className="text-xs text-black dark:text-zinc-500">
                    {t("mobile.minOrder")}: {service.min} {t("mobile.maxOrder")}: {service.max}
                  </div>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <div className="text-zinc-400">{t("mobile.pricePer1k")}</div>
                  <div className="text-zinc-100">{service.price} UZS</div>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <div className="text-zinc-400">{t("mobile.averageTime")}</div>
