...
const GOOGLE_CLIENT_ID =
	'577050887686-u4ecvvk0ubatcvo72vesbhir7voindur.apps.googleusercontent.com'
...
export default function Page() {
	...
	// Google credential callback (HTML faylingizdagi kabi)
	const handleGoogleResponse = async (response: GoogleCredentialResponse) => {
		...
		try {
			...
			// Send token to backend using googleLogin action
			await toast.promise(googleLogin(response.credential), {
				loading: 'Google bilan kirilmoqda...',
